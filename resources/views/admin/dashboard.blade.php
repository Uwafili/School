        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                ...
                <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                    ...
                    <span class="text-gray-700 mt-2"><a href="{{ route('storeapprove') }}">Manage stores</a></span>
                </div>
                <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center">
            ...
            <div class="bg-white rounded-lg shadow p-8">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#"
                        class="bg-yellow-100 hover:bg-yellow-200 text-yellow-700 px-6 py-3 rounded-lg font-semibold transition">Add
                        User</a>
                    <a href="#"
                        class="bg-yellow-100 hover:bg-yellow-200 text-yellow-700 px-6 py-3 rounded-lg font-semibold transition">Add
                        Store</a>
                    <a href="#"
                        class="bg-yellow-100 hover:bg-yellow-200 text-yellow-700 px-6 py-3 rounded-lg font-semibold transition">View
                        Reports</a>
                </div>
            </div>
        </div>
        ...
        @foreach ($posts as $post)
            <div class="bg-white rounded-lg shadow p-3">
                ...
                <form action="{{ route('posts.destroy', $post->id) }}" method="POST"
                    onsubmit="return confirm('Are you sure you want to delete this post?');" class="mt-3">
                    @csrf
                    @method('DELETE')
