                ...
                <div class="bg-red-50 border-2 border-red-200 rounded-lg p-6 mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-red-700 text-sm mb-3">You cannot create a store because you are registered as a
                                rider.</p>
                            <p class="text-red-700 text-sm mb-3 font-semibold">Each account can only have one role (Rider OR
                                Store Owner)</p>
                            ...
                            <a href="{{ route('home') }}"
                                class="inline-block bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-semibold transition">←
                                Back to Home</a>
                        </div>
                    </div>
                </div>
